      ...
      <div className="flex flex-col min-w-max">
        ...
        <div className="flex-1 flex relative">
          ...
          {days.map((day, colIndex) => (
            <div key={day.dayIndex} data-day-index={day.dayIndex} className={`shrink-0 border-r border-gray-100 relative ${day.date.getDay() === weekStartDay ? 'snap-start snap-always' : ''}`} style={{ width: dayWidth, ...(day.isToday ? { backgroundColor: accentColor + '05' } : {}) }}>
              {hours.map((_, i) => (
